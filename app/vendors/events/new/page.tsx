...
export default async function NewEventPage() {
  try {
    ...
    if (!user) {
      redirect("/login?redirect=/vendors/events/new");
    }
            ...
            <section className="section-shell">
              <div className="max-w-2xl mx-auto card-glass p-8 text-center">
                ...
                <p className="text-muted mb-6">
                  You need a vendor account to create events. Please register as a vendor first.
                </p>
      ...
      return (
        <div className="min-h-screen text-white flex flex-col">
          <main className="flex-1">
            <section className="section-shell">
              <div className="max-w-2xl mx-auto card-glass p-8 text-center">
                <h1 className="text-2xl font-bold mb-4 text-yellow-400">Vendor Application Pending</h1>
                <p className="text-muted mb-6">
                  Your vendor application is currently under review. Once approved, you'll be able to create events.
                </p>
      ...
      return (
        <div className="min-h-screen text-white flex flex-col">
          <main className="flex-1">
            <section className="section-shell">
              <div className="max-w-2xl mx-auto card-glass p-8 text-center">
                <h1 className="text-2xl font-bold mb-4 text-red-400">Vendor Account Suspended</h1>
                <p className="text-muted mb-6">
    ...
    console.error("[vendors/events/new] Error:", error);
    return (
      <div className="min-h-screen text-white flex flex-col">
        <main className="flex-1">
          <section className="section-shell">
